...
public class runLiveVNect : MonoBehaviour
{
    ...
    {
        m_WSClient.Update();
        string Line = m_WSClient.m_Message;
    ...
    private void drawEllipsoid(Vector3 Start, Vector3 End, GameObject Bone)
    {
        // Go to unit sphere
